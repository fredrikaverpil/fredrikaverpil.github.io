...
Howdy! There's a newer version of this script [here](/blog/2016/05/23/read-node-from-write-node/).
...
Place the Python script in the /scripts dir inside your `NUKE_PATH` (see my previous post [here](/blog/2011/10/28/nuke-6.3-small-studio-setup-for-windows/os-x/) on setting this up). Add the following to your `menu.py`:
