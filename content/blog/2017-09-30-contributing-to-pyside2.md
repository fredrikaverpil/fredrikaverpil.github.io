...
```bash
cd ~/code/repos/_gerrit/pyside-setup
curl -o .git/hooks/commit-msg https://codereview.qt-project.org/tools/hooks/commit-msg
...
Official docs on this is found [in the docs](https://wiki.qt.io/Gerrit_Introduction). [QtC](https://www.qt.io) then has a [commit policy](https://wiki.qt.io/Commit_Policy) which you may want to read.
