...
featured_image: "/blog/assets/editor/sublime_material.png"
---
...
* [`SublimeLinter`](https://www.sublimelinter.com/en/latest/) - Faster than in ST2
* [`BracketHighlighter`](https://github.com/facelessuser/BracketHighlighter) - Bracket and tag highlighter
* [`Sublimerge Pro`](https://www.sublimerge.com) - Great tool for checking diffs
...
It's possible to use e.g. [Anaconda](https://damnwidget.github.io/anaconda/) for custom build systems, or you can just use `ctrl+b` (or `cmd+b` on OS X) to run the current Python script.
