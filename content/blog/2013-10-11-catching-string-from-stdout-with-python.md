...
Here’s an example of catching the output of a V-Ray for Maya render and outputting `TR_PROGRESS nnn%` to stdout whenever a percentage is being printed to stdout, which makes [Pixar’s Tractor](https://renderman.pixar.com/view/pixars-tractor) show a task progress in the task node tree.
