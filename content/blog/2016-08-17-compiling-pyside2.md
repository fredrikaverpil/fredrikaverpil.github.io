...
> [!NOTE]
> 
> Before reading on, this blog post is now _very_ outdated. You may want to skip this alltogether and go directly to my pre-built standalone Python wheels and the most up to date build recipes there:
...
> 
> Also, official standalone wheels have been [released](https://lists.qt-project.org/pipermail/pyside/2018-March/002537.html). PySide2 can now be installed from pypi.org: `pip install PySide2`!
...
Autodesk has also provided the version of PySide2 they used in Maya 2017 on their [open source distributions page](https://www.autodesk.com/company/legal-notices-trademarks/open-source-distribution). If you prefer that, you can download the PySide2.zip file from there and use that instead.
...
This is yet another aging sign of Python 2.x. Personally, I'm developing with Python 3.5 as the interpreter of choice in my IDE and I make sure my code is backwards compatible with Python 2.7, which is actually very easy for the most part. I think that the [VFX Reference Platform](https://www.vfxplatform.com) should plan ahead (starting now) for a move onto Python 3.5 as there is great reluctancy in the industry towards this move. It'll involve a lot of code porting, yes, but with enough headsup time this shouldn't be blocking such a move. It's a developer's world, this is how it works. You can't hold on to old code forever.
