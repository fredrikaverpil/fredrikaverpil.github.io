...
[Chaosgroup forums](https://forums.chaosgroup.com/showthread.php?87709-Cannot-load-vrmesh-file-1001th-vrmesh),
...
Read more on the `resource` module [https://docs.python.org/2/library/resource.html](https://docs.python.org/2/library/resource.html).
