...
> 
> The Qt Company now offers official and standalone wheels, read more [here](../2018-03-09-official-pyside2-wheels/).  
...
You can then cross reference the commit date/hash against the [`pyside-setup` git repository](https://code.qt.io/cgit/pyside/pyside-setup.git/) if you wish to figure out exactly which commit was used to build the wheel. Or you can check the respective CI output where I print the commit's info (`git log -n 1`).
