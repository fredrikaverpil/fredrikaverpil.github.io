...
This quick guide details compiling sip and PyQt5 on OS X 10.11 (El Capitan) using [Homebrew](https://brew.sh) for Qt5 installtion.
...
Then let’s download the [PyQt5 source for Linux and OS X](https://riverbankcomputing.com/software/pyqt/download5) and the prerequisite [SIP source](https://riverbankcomputing.com/software/sip/download).
    ...
    wget https://freefr.dl.sourceforge.net/project/pyqt/sip/sip-4.18/sip-4.18.tar.gz
