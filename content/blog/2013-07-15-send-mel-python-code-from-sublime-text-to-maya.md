...
Huge thanks goes out to [Justin Israel](https://justinfx.com) who provided the package.



### More on packages

Another useful package is [Sublimerge](https://www.sublimerge.com), which helps you compare code from different versions of the same script, much like how [WinMerge](https://winmerge.org) works. Please note that Sublimerge will [change some key bindnings](https://www.sublimerge.com/docs/configuration.html#default-key-bindings) which may have to disable, depending on which keyboard layout you are using.
