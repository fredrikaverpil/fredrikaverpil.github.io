...
Place the Python script in the /scripts dir inside your `NUKE_PATH` (see [Nuke 6.3 Small studio setup for Win/Mac](../2011-10-28-nuke-63-small-studio-setup-for-windows-osx/) on setting this up). Add the following to your `menu.py`:
