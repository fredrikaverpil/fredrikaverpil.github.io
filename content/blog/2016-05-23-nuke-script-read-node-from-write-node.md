...
- [Nukepedia](https://www.nukepedia.com/python/misc/readfromwrite)
- [Github](https://raw.github.com/fredrikaverpil/nuke/master/scripts/readFromWrite.py)

### Installation instructions

Place the Python script in the /scripts dir inside your `NUKE_PATH` (see [Nuke 6.3 Small studio setup for Win/Mac](/blog/2011/10/28/nuke-6.3-small-studio-setup-for-windows/os-x/) on setting this up). Add the following to your `menu.py`:
