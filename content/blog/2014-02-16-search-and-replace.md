...
The script was written in Python and utilizes PySide/PyQt (choose which one you wish to use in upper portion of the Python script). Since it uses [my boilerplate](/blog/2013/10/06/a-pyside/pyqt4-boilerplate-for-maya-nuke-or-standalone/), you can also launch it from within Maya or Nuke...
