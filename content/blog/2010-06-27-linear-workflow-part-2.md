...
![](/blog/assets/linear_workflow/lw01_bobbycar_no_correction.png)

The image you just rendered was created in linear space and is now presented on screen without a gamma 2.2 correction, thus would show correctly on a display device with gamma 1.0 but does not display correctly on a usual workstation display or laptop screen, which is usually using a gamma of 2.2 (or [sRGB](https://en.wikipedia.org/wiki/SRGB), which is approximately gamma 2.2).
...
![](/blog/assets/linear_workflow/lw02_attach_lens_shader.png)
...
![](/blog/assets/linear_workflow/lw03_mia_exposure_simple1_settings.png)
...
![](/blog/assets/linear_workflow/lw04_bobbycar_corrected.png)
...
![](/blog/assets/linear_workflow/lw05_bobbycar_shaded.png)
...
![](/blog/assets/linear_workflow/lw06_gamma_node.png)
...
![](/blog/assets/linear_workflow/lw07_gamma_node_settings.png)
...
![](/blog/assets/linear_workflow/lw08_mia_exposure_simple1_settings_gamma1.png)
...
![](/blog/assets/linear_workflow/lw09_render_globals.png)
...
![](/blog/assets/linear_workflow/lw10_file_format.png)

Let us pick the OpenEXR file format for rendering.

![](/blog/assets/linear_workflow/lw11_batchrender.png)
...
![](/blog/assets/linear_workflow/lw14_nuke_settings.png)
...
![](/blog/assets/linear_workflow/lw15_nuke_grade.png)
...
![](/blog/assets/linear_workflow/lw16_nuke_render.png)
