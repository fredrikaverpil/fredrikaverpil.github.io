...
Quote from [rBrady’s post](https://forum.mentalimages.com/showthread.php?t=6424&page=2) on the mental forums:
...
Then you’re supposed to turn Iray on inside of Maya as well, according to [this post](https://forums.cgsociety.org/showpost.php?p=6500383&postcount=34), by entering the following in the script editor:
...
More test renders and information on Iray usage can be found over at [this CGTalk thread](https://forums.cgsociety.org/showthread.php?t=877874). And oh yeah, don’t forget you’ll need a [CUDA-compatible](https://www.nvidia.com/object/cuda_gpus.html) graphics card in the box.

Personally, I’ll stick with what was intended for the Maya 2011 release and check out [Octane](https://www.refractivesoftware.com/) instead.
