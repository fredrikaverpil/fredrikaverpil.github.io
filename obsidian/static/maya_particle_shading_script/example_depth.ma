...
//Name: example_depth.ma
//Last modified: Wed, Apr 27, 2005 11:12:45 PM
requires maya "5.0";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 17.217850102307942 26.726230037726207 -23.829769591154694 ;
	setAttr ".r" -type "double3" -17.1383527296023 146.59999999998928 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 32.414386945745953;
...
createNode transform -n "nurbsPlane1";
	setAttr ".t" -type "double3" 0 23.477598181596392 0 ;
...
createNode transform -n "particle1";
	setAttr ".t" -type "double3" 0 4.1167832220633809 0 ;
createNode particle -n "particleShape1" -p "particle1";
	...
	setAttr ".usc" yes;
	setAttr ".scp" -type "string" "example_depth_startup";
	...
	setAttr ".irx" -type "string" (
		...
		+ "\r\n"
		+ "// SET COLOR\r\n"
		+ ".O[1] = <<$outValueDepth,$outValueDepth,$outValueDepth>>;");
...
createNode transform -n "camera1";
	setAttr ".t" -type "double3" 6.4862676007764577 15.848747123899592 0 ;
