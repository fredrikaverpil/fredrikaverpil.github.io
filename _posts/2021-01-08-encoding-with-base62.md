...
Sometimes, the `+` and `/` characters can be undesired in the encoded string. An example could be a unique id ([UUID](https://en.wikipedia.org/wiki/Universally_unique_identifier)) base62-encoded, to be used in a URL.
